...
```{r}
dice_rolls = c(10,5, 7, 4, 8, 8, 7, 11, 6, 6, 3, 2, 5, 12, 2, 4, 10, 5, 7, 7)  # actually roll two dice and add them at least ten times. Enter your data here.
...
dice_sums <- 0 
num_rolls = 100000    # pick a big number and replace 100 with your number. 
...
dice_data %>% 
  ggplot(
   ...
   stat_function(      #draws bell curve
    ...
    geom_vline(
     xintercept = sum_left,    #plots all vertical lines at once. 
     col="violet", 
     linetype="longdash",
     size=2)
dice_data %>% 
